    ...
    def calculate_period_volatility(self, ticker, start_date, end_date, period, volatility_type):
        ...
        try:
            ...
            if period == "Daily":
                ...
                scaling_factor = np.sqrt(52)  # Annualized weekly volatility
                ...
                scaling_factor = np.sqrt(12)  # Annualized monthly volatility
                ...
                scaling_factor = np.sqrt(4)  # Annualized quarterly volatility
            ...
            if volatility_type == "Raw":
                ...
                # Calculate annualized compound growth rate (CAGR)
                cumulative_return = (1 + returns).prod()
                time_periods = len(returns)

                # Convert to annualized rate based on period
                if period == "Daily":
                ...
                if abs(annualized_growth) < 1e-10:  # Avoid division by near-zero
