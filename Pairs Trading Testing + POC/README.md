...
Simple_Backtest.py calculates the theoretical profit that would result from spread trading on set assets during a given period (using β0, β1 from trailing 8mo, entering at |z| = 1.96 and exiting at |z| = 0.5)
